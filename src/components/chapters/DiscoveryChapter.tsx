...
const DiscoveryChapter = forwardRef<HTMLElement, DiscoveryChapterProps>(({ darkMode }, ref) => {
            ...
            <div className="relative z-10 text-center px-6 max-w-5xl">
                ...
                <motion.div
                    ...
                    className={`${darkMode ? "bg-white/10" : "bg-white/80"
                        } backdrop-blur-xl rounded-3xl p-8 shadow-2xl transform hover:scale-105 transition-all duration-500`}
                >
                    {/* User Info */}
                    <motion.div
                    ...
                    <div className="flex flex-wrap gap-2 mb-6">
                        {["🏔️ Hiking", "🎬 Indie Films", "🎲 Board Games"].map((tag, i) => (
                            <motion.span
                                ...
                                className="px-4 py-2 bg-purple-500 text-white rounded-full text-sm font-medium shadow-lg cursor-pointer"
                            >
                                {tag}
                            </motion.span>
                        ))}
                    ...
                    >
                        ...
                        <motion.button
                            ...
                            whileTap={{ scale: 0.95 }}
                            className="w-full bg-white text-green-600 font-bold py-3 rounded-xl shadow-lg"
                        >
                            Join Live Activity
                        </motion.button>
...
DiscoveryChapter.displayName = "DiscoveryChapter";
