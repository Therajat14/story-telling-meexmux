    ...
    ({ darkMode }, ref) => {
        ...
        return (
            <section
                ...
                className={`chapter relative min-h-screen flex items-center justify-center overflow-hidden transition-all duration-700 ${darkMode
                        ? "bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-900 text-white"
                        : "bg-gradient-to-br from-indigo-200 via-purple-100 to-pink-100 text-gray-900"
                    }`}
            >
                {/* Background Elements */}
                ...
                <div className="relative z-10 px-4 sm:px-6 md:px-8 lg:px-12 py-16 sm:py-20 max-w-6xl w-full">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-12 lg:gap-16 items-center">
                        ...
                        <div ref={leftColumnRef} className="space-y-6 sm:space-y-8">
                            <div className="flex items-center gap-3">
                                <div ref={compassRef}>
                                    <Compass className="w-7 h-7 sm:w-8 sm:h-8 text-pink-400" />
                                </div>
                    ...
                    <p
                        ref={quoteRef}
                        className="text-center mt-10 sm:mt-12 mb-10 sm:mb-14 text-base sm:text-lg md:text-xl italic opacity-80 leading-relaxed px-4"
                    >
